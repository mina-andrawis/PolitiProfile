      ...
      <div className="p-6">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-lg bg-white p-6 shadow-md">
            <h2 className="mb-4 text-2xl text-secondaryText font-semibold">What is PolitiProfile?</h2>
          ...
          <div className="rounded-lg bg-white p-6 shadow-md">
            <h2 className="mb-4 text-2xl text-secondaryText font-semibold">How PolitiProfile Empowers You</h2>
            <hr className="my-4 border border-primary" />
            <p className="text-secondaryText">
            ...
            <ul className="list-disc list-inside mt-4 text-secondaryText">
          ...
          <div className="rounded-lg bg-white p-6 shadow-md">
            <h2 className="mb-4 text-2xl text-secondaryText font-semibold">Championing the Representatives Who Make a Difference</h2>
            <hr className="my-4 border border-primary" />
            <p className="text-secondaryText">
          ...
          <div className="rounded-lg bg-white p-6 shadow-md">
            <h2 className="mb-4 text-2xl text-secondaryText font-semibold">Taking Back Control of Politics</h2>
            <hr className="my-4 border border-primary" />
            <p className="text-secondaryText">
          ...
          <div className="rounded-lg bg-white p-6 shadow-md">
            <h2 className="mb-4 text-2xl text-secondaryText font-semibold">Get Involved</h2>
            <hr className="my-4 border border-primary" />
            <p className="text-secondaryText">
            ...
            <p className="text-secondaryText font-bold mt-4">
