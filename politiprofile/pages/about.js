      ...
      <div className="p-6">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-lg bg-white p-6 shadow-md">
            <h2 className="mb-4 text-2xl text-dark font-semibold">What is PolitiProfile?</h2>
          ...
          <div className="rounded-lg bg-white p-6 shadow-md">
            <h2 className="mb-4 text-2xl text-dark font-semibold">How PolitiProfile Empowers You</h2>
            <hr className="my-4 border border-primary" />
            <p className="text-dark">
            ...
            <ul className="list-disc list-inside mt-4 text-dark">
          ...
          <div className="rounded-lg bg-white p-6 shadow-md">
            <h2 className="mb-4 text-2xl text-dark font-semibold">Championing the Representatives Who Make a Difference</h2>
            <hr className="my-4 border border-primary" />
            <p className="text-dark">
          ...
          <div className="rounded-lg bg-white p-6 shadow-md">
            <h2 className="mb-4 text-2xl text-dark font-semibold">Taking Back Control of Politics</h2>
            <hr className="my-4 border border-primary" />
            <p className="text-dark">
          ...
          <div className="rounded-lg bg-white p-6 shadow-md">
            <h2 className="mb-4 text-2xl text-dark font-semibold">Get Involved</h2>
            <hr className="my-4 border border-primary" />
            <p className="text-dark">
            ...
            <p className="text-dark font-bold mt-4">
